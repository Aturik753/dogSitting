...
function officeLookNorth() {
  let message =
    "You look north in the Office and see a short bookshelf to the left with plants on top.\n";
  message +=
    "To the right, you see part of a curving desk whith a telephone, notepad and pencils.\n";
  message += "Item list = Bookshelf, Phone, Pad, Pencils";
  return message;
}
function officeSearchBookshelf() {
  let message =
    "You search the small bookshelf and notice one book is more worn that the others.\n";
...
function officeSearchWornBook() {
  ...
  message +=
    "You bend down and pick up a key.  When you look closer, the numbers 835 are on it.\n";
  message += "Item list = Key835";
  return message;
}
...
function officeSearchPhone() {
  ...
  message +=
    "You hold your breath and listen.  It almost sounds like someone else is dialing out!\n";
  message +=
    "You listen but realize you hear the same series of beeps, over and over\n";
...
function officeSearchPad() {
  let message =
    "It looks as though someone made a note on the previous sheet!\n";
  message +=
    "They pressed hard enough that it left an impression on the top of the pad";
  return message;
}
function officeUsePencil() {
  let message =
    "You grab the pencil and begin to rub gently on the top of the pad.\n";
  message += "You begin to see the previous message is showing up a little.\n";
  message +=
    "Once complete, you can make out most of the message but not all of it.\n";
  message += "P t  Fu  ral  S  vi e";
  return message;
}
function officeLookEast() {
  let message =
    "You look east in the Office and see a computer sitting on the desk.\n";
...
function officeSearchComputer() {
  let message =
    "You sit down in the large office chair and wiggle the mouse.\n";
...
function officeLookSouth() {
  ...
  message +=
    "On the right of the door you see a comfortable looking couch and chair.\n";
...
function officeUseDogLifePoochFriend() {
  ...
  message +=
    "Oh no!!! What comes onto the screen is what looks like a live video!\n";
  message +=
    "you see puppy!  But where is he?  You can't see much more in the video\n";
  message += "He looks ok, but you must find him!  Where could he be?\n";
  message +=
    "And why would there be a video camera on him and fed to this computer?";
  return message;
}
...
function officeSearchSwingingDoor() {
  ...
  message += "Item list, you found a new room = Kitchen";
  return message;
}
