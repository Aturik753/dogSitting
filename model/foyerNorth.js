...
function foyerNorthStaircaseUseKey64() {
  ...
  message +=
    "If you would like to go through the staircase door, go to http://localhost:3000/Hallway";
  return message;
}
...
function foyerNorthSearchMirror() {
  ...
  message +=
    "You wonder if there is anything that could help you see it better";
  return message;
}
function foyerNorthUseFlashlight() {
  let message =
    "You take out the strange flashlight you found in the Library.\n";
  message +=
    "You turn it on and notice your white shoes are illuminated but not your pants!\n";
  message +=
    "As you point it towards the mirror, you begin to make out a message......\n";
