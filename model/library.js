function libraryEnter() {
  let message =
    "you enter the Library and call for the puppy but hear nothing.\n";
  return message;
}
...
function libraryNorthSearchBookshelves() {
  let message =
    "You take a closer look at the bookshelves on the North wall of the Library\n";
  message +=
    "There are a mix of old and new books with a vast array of topics!\n";
  message += "Is there a particular book you would like to search closer?";
  return message;
}
function libraryNorthSearchDoor() {
  let message =
    "You search the Door on the North side of the Library and discover it's unlocked\n";
  message += "You open the door and see that it leads to an office\n";
  message += "Item list, you found a new room = Office";
  return message;
}
...
function libraryEastSearchFireplace() {
  ...
  message +=
    "You see a picture frame containing a photo of a dog that looks similar to puppy!\n";
...
function libraryEastSearchBrick() {
  let message =
    "You reach up to touch the brick and see that it is a little loose.\n";
...
function libraryEastSearchHole() {
  ...
  message +=
    "Against your better judgement, you reach your hand into the hole \n";
  message +=
    "and you feel something cold.  You pull back, take a breath and try again.\n";
  message +=
    "You reach in again and you wrap your hands around whatever it is and pull it out!\n";
  message +=
    "In your hand you see a strange coin.  You have no idea where it is from or what it's for.";
  message += "Item list = Coin";
  return message;
}
...
function libraryEastSearchArmchair() {
  let message =
    "You search the armchairs by the fireplace on the east side of the Library.\n";
...
function libraryEastSearchLamp() {
  ...
  message +=
    "As you reach up to turn one of the lamps on, you feel something there!\n";
  message += "You grab hold of it and pull it out.\n";
  message += "You have found a flashlight!\n";
  message += "Item list = Flashlight";
  return message;
}
function libraryEastSearchFlashlight() {
  let message =
    "You search the flashlight, and notice it in not a normal flashlight.\n";
...
function librarySouthSearchDesk() {
  ...
  message +=
    "and a few pens.  There are several drawers on either side of the desk./n";
  message += "Item list = Drawers";
  return message;
}
function librarySouthSearchDrawers() {
  let message =
    "Most of the drawers are empty, but you find a piece of paper with writing on it.\n";
  message += "Item list = Paper";
  return message;
}
function librarySouthSearchPaper() {
  let message =
    "You take a closer look at the paper and see a list of books.\n";
...
function libraryNorthSearchHarryPotter() {
  let message =
    "You move back over to the north side of the Library and search the bookshelves.\n";
  message +=
    "You find the book Harry Potter and notice the dust pattern around it has been disturbed.\n";
  message +=
    "You pull Harry Potter from the shelf.  Nothing about the book seems out of place.\n";
  message +=
    "You begin to flip through the pages and you notice a piece of paper has fallen out.\n";
  message +=
    "You bend over to pick up the piece of paper and notice the number 45 on it.\n";
  message += "Item list = Piece of paper with the number 45 on it";
  return message;
}
function libraryNorthSearchMacbeth() {
  let message =
    "You search the bookshelves on the north side of the Library and find Macbeth.\n";
  message +=
    "You open Macbeth to find an inscription on the inside of the front cover.\n";
  message +=
    "To my dearest, may Shakespeare always remain in your heart!.  Love always, 18 to forever.\n";
  message += "Item list = 18 to forever";
  return message;
}
function libraryNorthSearcDictionary() {
  let message =
    "You find the Dictionary on the middle bookshelf on the bottom right side.\n";
  message += "You pick up the Dictionary and don't notice much about it.\n";
  message +=
    "As you begin to flip through the pages, you notice that one of the pages is dog-eared.\n";
  message +=
    "You take a closer look at that page.  There are no words on this page 72 that seem strange.\n";
  message += "Item list = Page 72 dog-eared";
  return message;
}
function libraryNorthSearchJSForDummies() {
  let message =
    "You find the book JS for Dummies on the far left of the bookshelves.\n";
  message +=
    "It appears this book has been used alot.  You open it up and begin to read about Java Script.\n";
  message +=
    "You are facinated as you have always wanted to learn more about JS and programming in general.\n";
  message +=
    "After some time, you realize that you are here to find puppy, not lean about JS!.\n";
  message +=
    "As you reach up the put the book back, you notice a keypad at the back of the shelf\n";
...
function libraryNorthUseKeypad() {
  let message = "Hint-to use keypad, enter a code after the word keypad";
  return message;
}
function libraryNorthUseKeypad457218() {
  ...
  message +=
    "You reach out and give the bookshelf a little push and feel it move further.\n";
  message +=
    "You begin to push with more force and the entire bookshelf swings away from you\n";
