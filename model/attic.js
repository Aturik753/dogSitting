function enterBookshelfRoom() {
  let message =
    "You slowly move the bookshelf door farther to try and let more light in.\n";
  message += "You still can't see anything beyond the doorway.\n";
  message +=
    "You take a deep breath and step inside.  You listen and hear nothing.\n";
  message += "The door swings shut behind you!";
  return message;
}
function searchBookshelfRoom() {
  let message =
    "As you take a step deeper, you triger a motion sensor and a mild light turns on.\n";
  message +=
    "You are in a small room with bare stone walls in every direction.\n";
  message +=
    "To the south, you see an outline of a door in the rocks with a lever.\n";
  message +=
    "To the west, you see an outline of a door in the rocks with no way to open it\n";
...
function bookshelfRoomSearchLever() {
  let message =
    "You take a closer look at the lever on the south wall of the room.\n";
...
function bookshelfRoomSearchSpiralStairs() {
  let message =
    "You look at the spiral stairs and decide to go up and take a look.\n";
  message += "At the top of the stairs, you find a room full of storage.\n";
  message += "You found a new room! = Attic.\n";
  message +=
    "Please go to http://localhost:3000/Attic to continue in this room.";
  return message;
}
function attic() {
...
function atticSearchSouth() {
  let message =
    "You look south and see a large dusty mirror and your reflection.\n";
...
function atticSearchGumballMachine() {
  ...
  message +=
    "There doesn't appear to be as much dust on it as most of the other items";
  return message;
}
function atticUseCoin() {
  let message = "You pull a few coins out of your pocket.\n";
  message +=
    "You try everything you have.  Toonie, Loonie, quarter, dime and nickel.\n";
  message +=
    "Nothing seem to happen, other than you have lost some money and have a few gumballs!\n";
  message +=
    "Oh, remember the coin you found in the hole behind the loose brink in the Library?\n";
  message +=
    "You wonder if anything would happen if you use it in the gumball machine!\n";
  message +=
    "You drop the strange coin into the machine, turn the crank, and no gum......\n";
  message +=
    "You hear some gears and cranks turning somewhere, and the mirror swings open!\n";
  message += "You found something new = SecretDoor!\n";
  return message;
}
function atticSearchSecretDoor() {
  let message =
    "You look through the opening that was consealed by the mirror in the attic.\n";
  message += "You see a thin hallway that takes an L off to the left\n";
  message +=
    "You go down the hall and look to the left, and see what looks like sound equipment!\n";
